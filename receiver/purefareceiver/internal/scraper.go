...
func getHTTPConfig(sccfg ScraperConfig, host component.Host) (configutil.HTTPClientConfig, error) {
	ret := configutil.HTTPClientConfig{}
	if sccfg.Auth != nil {
		bearerToken, err := RetrieveBearerToken(*sccfg.Auth, host.GetExtensions())
		if err != nil {
			return ret, err
		}
